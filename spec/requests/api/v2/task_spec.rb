...
RSpec.describe 'Task API' do
    ...
    describe 'GET /tasks' do
        ...
        context 'when filter and sorting param is sent' do
            ...
            it 'returns only the task matching' do
    ...
    describe 'POST /tasks' do
        ...
        context 'when the params are valid' do
            ...
            it 'returns the json fo created task' do
        ...
        context 'when the params are invalid' do
            ...
            it 'does not save the task in the datebase' do
    ...
    describe 'PUT /tasks/:id' do
        ...
        context 'when the params are valid' do
            ...
            it 'returns the json fo update task' do
                expect(json_body[:data][:attributes][:title]).to eq(task_params[:title])
            end
    ...
    describe 'DELETE /task/:id' do
        ...
        it 'remove the task from the database' do
